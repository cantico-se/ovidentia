...
function displayStatisticPanel($idx)
{
	...
	class displayStatisticPanelCls
		...
		function displayStatisticPanelCls($idx)
			...
			$this->itemarray[] = array( array('idx' => 'mod', 'item' => bab_translate("Modules"), 'url' => $GLOBALS['babUrlScript']."?tg=stat&idx=mod"), array('idx' => 'xlink', 'item' => bab_translate("External links"), 'url' => $GLOBALS['babUrlScript']."?tg=stat&idx=xlink")
			...
			$this->itemarray[] = array( array('idx' => 'ovml', 'item' => bab_translate("Ovml Files"), 'url' => $GLOBALS['babUrlScript']."?tg=stat&idx=ovml"), array('idx' => 'addon', 'item' => bab_translate("Addons"), 'url' => $GLOBALS['babUrlScript']."?tg=stat&idx=addon"));
