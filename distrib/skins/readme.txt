...
- From the original skin, copy in 'templates' templates files that you want to change
- From the original skin, copy in 'styles' css file that you want to customize
