...
$babInstallPath = "ovidentia3-1"; /* path to ovidentia distribution */
...
$babUrl = "http://localhost/bab31/example/"; /* url to access to your site */
$babAdminEmail = "admin@your-domain.com"; /* email address used to send emails ( registration, ... ) */
$babLanguage = "fr"; /* default language */
$babMaxRows = 10; 
$babVersion = "3.1"; /* current version */
