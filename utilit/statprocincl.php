...
/**
 * 
 * @param int $statrows		Number of records to process
 * @param int $statlimit	limit in query
 * @param bool $statecho	display process result as HTML in babBody
 * 
 * @return array	total,count
 */
function bab_stat_process($statrows = OVSTAT_ROWS, $statlimit = OVSTAT_LIMIT, $statecho = false)
{
