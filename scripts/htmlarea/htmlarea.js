...
HTMLArea.prototype._babcleanhtml = function() {
 ...
 if (confirm(msg))
 {
	...
	selected = range.parentElement();
		...
		{selected = range.startContainer.previousSibling;} // cette ligne n'est pas encore utilisée
...
// fonctions dupliquées sur fullscreen.html
