...
//				$bIsParticipationStatusOk = (BAB_TM_ACCEPTED == $iParticipationStatus || $iParticipationStatus == BAB_TM_IN_PROGRESS);
        ...
        function initFormVariables()
        {
            ...
            if($bIsCreation || $bIsResubmission)
            {
                ...
                $iPlannedStartHour = null;
                $iPlannedStartMinut = null;
                $sPlannedEndDate = null;
                $iPlannedEndHour = null;
                $iPlannedEndMinut = null;
                $sStartDate = null;
                $iStartHour = null;
                $iStartMinut = null;
                $sEndDate = null;
...
//*/
            ...
            //Lors de la mise a jour d'une tache cette variable n'est pas
            //poste si on est pas gestionnaire
...
//*/
    ...
    class BAB_TM_TaskUpdaterValidator extends BAB_TM_MgrTaskValidatorBase
    {
        ...
        function init()
        {
            ...
            //Si on a change de type
            if($this->m_iClass != $aTask['iClass'])
            {
                //si c'etait une tache
