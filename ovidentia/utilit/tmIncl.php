...
function bab_createProject($iIdProjectSpace, $sName, $sDescription, $iMajorVersion, $iMinorVersion)
{
    ...
    if(false != $res)
    {
        ...
        //Recuperation des champs additionnels au niveau espace de projet
...
function bab_tskmgr_createAdditionalField($iIdProjectSpace, $iIdProject, $iFieldType, $iIdFieldClass, $sFieldValue)
{
    ...
    else if(0 < $iIdProjectSpace && 0 == $iIdProject)
    {
        ...
        $sMessage = 'Ajouter le champ a tous les projets de l\'espace ==> ' . $iIdProjectSpace;
    }
    else
    {
...
//	bab_debug('bab_tskmgr_createAdditionalField ' . $sMessage);
    ...
    //Recuperer la liste de toutes les taches perso ou du projet
    //Si la tache existe alors on lui rajoute la valeur par dEfaut
    //Si la tache n'existe pas alors on creer une entree pour la tache et on lui rajoute la valeur par defaut
...
//Appele lors de la mise a jour d'une tache
