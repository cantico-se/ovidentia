...
class bab_cal_OviEventSelect
{
    ...
    private function setEventsPeriods(bab_UserPeriods $user_periods, $calendars = null, $ical = null, $hash = null, $uid_criteria = null) {
        ...
        while( $arr = $babDB->db_fetch_assoc($res))
        {
            //Ajout de parent calendar a cause de doublon sur deux agendas differents
            $d_key = md5($arr['parent_calendar'].$arr['start_date'] . $arr['end_date']. $arr['title'].$arr['location'].$arr['id_cat'].$arr['description']);
