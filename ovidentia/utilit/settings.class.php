...
class bab_Settings
{
	 ...
	 * @return array
	 */
	public function getSiteSettings($siteName = null)
	{
		...
		if (null === $this->siteSettings)
		{
			...
			if (!isset($siteName) && isset($GLOBALS['babSiteName']) ) {
			    $siteName = $GLOBALS['babSiteName'];
			}
			
			if (isset($siteName)) {
			    $req .= " where name='".$babDB->db_escape_string($siteName)."'";
			}
