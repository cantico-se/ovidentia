...
function listArticles($id)
{
    ...
    class listArticlesTpl
    {
        ...
        function __construct($id)
        {
            ...
            $req = "
                SELECT at.*, adt.id_article, adt.id AS id_draft, adt.id_author AS id_author, public.id AS public, private.id AS private
                FROM " . BAB_ARTICLES_TBL . " AS at
                LEFT JOIN " . BAB_ART_DRAFTS_TBL . " AS adt
        ...
        function getnextlog()
        {
            ...
            if ($i < $this->count) {
                ...
                switch ($arr['action_log']) {
                    case 'lock':
                        $this->action = bab_translate("Lock");
                        break;
                    case 'unlock':
                        $this->action = bab_translate("Unlock");
                        break;
                    case 'commit':
                        $this->action = bab_translate("Commit");
                        break;
                    case 'refused':
                        $this->action = bab_translate("Refused");
                        break;
                    case 'accepted':
                        $this->action = bab_translate("Accepted");
                        break;
                    default:
                        $this->action = "";
                        break;
