...
//				echo sprintf('Updating %d : %s => %d.<br />', $file['id'], $file['path'] . $file['name'], $size);
     ...
     * Upgrade to 8.2.97
     */
    if(!bab_isTableField('bab_users', 'force_pwd_change'))
    {
        $babDB->db_query("ALTER TABLE bab_users ADD force_pwd_change tinyint(1) unsigned NOT NULL default '0'");
    }

    if(!bab_isTableField('bab_users', 'pwd_change_date'))
    {
