...
function displayOrderTaskFieldsForm()
{
    ...
    class BAB_OrderTaskFields extends BAB_BaseFormProcessing
    {
        function BAB_OrderTaskFields($iIdProjectSpace, $iIdProject)
        {
            ...
            $this->set_data('sSelectedField', '');//Utilise seulement lors du deplacement
            ...
            switch($sAction)
            {
                ...
                case 'sDownField':
                    ...
                    if(-1 != $iSelectedIndex)
                    {
                        ...
                        //Pour le deplacement vers le bas
                        //Vu que l'on supprime(unset) l'element a deplacer
        ...
        if($iNumRows > 0)
        {
            ...
            foreach($aFieldInfo as $sAlias => $sLegend)
            {
                if('sDescription' == $sAlias)
                {
                    ...
                    //on ne traite pas la description car l'editeur HTML
                    //remonte des caracteres qui genere des saut de lignes
                    continue;
                }
